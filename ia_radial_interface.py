...
def downsample_halo_parameters(nmass_halo, nmass_setup, mass_halo, c_halo, r_s_halo, rvir_halo):
...
def execute(block, config):
    ...
    nmass_halo = mass_halo.size #The dimension/resolution here has been set by the nmass in halo_model_ingredients.py
    ...
    mass, c, r_s, rvir = downsample_halo_parameters(nmass_halo, nmass_setup, mass_halo, c_halo, r_s_halo, rvir_halo)
